...
const getSystemInstruction = (gameState) => {
  const instructions = [
    ...
    "If you are unsure about the user's intent or lack sufficient information, ask clarifying questions instead of making assumptions or hallucinating a response.",
